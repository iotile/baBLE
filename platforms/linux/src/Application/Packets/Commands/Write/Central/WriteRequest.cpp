  ...
  namespace Commands {
    ...
    namespace Central {
      ...
      shared_ptr<AbstractPacket> WriteRequest::on_response_received(const shared_ptr<PacketRouter>& router,
        ...
        auto write_response_packet = dynamic_pointer_cast<Commands::Central::WriteResponse>(packet);
      ...
      shared_ptr<AbstractPacket> WriteRequest::on_error_response_received(const shared_ptr<PacketRouter>& router,
        ...
        shared_ptr<Commands::Central::WriteResponse> response_packet = make_shared<Commands::Central::WriteResponse>();
