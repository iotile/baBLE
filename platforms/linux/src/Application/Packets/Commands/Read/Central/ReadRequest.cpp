  ...
  namespace Commands {
    ...
    namespace Central {
      ...
      shared_ptr<AbstractPacket> ReadRequest::on_response_received(const shared_ptr<PacketRouter>& router,
        ...
        auto read_response_packet = dynamic_pointer_cast<Commands::Central::ReadResponse>(packet);
      ...
      shared_ptr<AbstractPacket> ReadRequest::on_error_response_received(const shared_ptr<PacketRouter>& router,
        ...
        shared_ptr<Commands::Central::ReadResponse> response_packet = make_shared<Commands::Central::ReadResponse>();
