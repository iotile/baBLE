#ifndef BABLE_LINUX_CENTRAL_READBYGROUPTYPEREQUEST_HPP
#define BABLE_LINUX_CENTRAL_READBYGROUPTYPEREQUEST_HPP
...
#endif //BABLE_LINUX_CENTRAL_READBYGROUPTYPEREQUEST_HPP
