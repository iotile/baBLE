...
uint16_t HCIFormatExtractor::extract_payload_length(const std::vector<uint8_t>& data) {
...
// Constructors
HCIFormatExtractor::HCIFormatExtractor(const std::vector<uint8_t>& data)
...
// Parsers
void HCIFormatExtractor::parse_header(const std::vector<uint8_t>& data) {
