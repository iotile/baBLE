...
def DeviceConnectedStart(builder): builder.StartObject(7)
...
def DeviceConnectedAddDeviceName(builder, deviceName): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(deviceName), 0)
