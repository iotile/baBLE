...
def DeviceFoundStart(builder): builder.StartObject(7)
...
def DeviceFoundAddDeviceName(builder, deviceName): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(deviceName), 0)
