...
def DeviceConnectedStart(builder): builder.StartObject(8)
...
def DeviceConnectedAddManufacturerData(builder, manufacturerData): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(manufacturerData), 0)
def DeviceConnectedStartManufacturerDataVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def DeviceConnectedAddDeviceName(builder, deviceName): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(deviceName), 0)
